section "Creating DEMO collaborative legislation" do
  ...
  process = Legislation::Process.create!(title: "Air Quality and Climate Change Plan",
                                         ...
                                         end_date: "31/12/2020",
                                         debate_start_date: "03/08/2019",
                                         debate_end_date: "31/10/2020",
  ...
  question.update(updated_at: "04/08/2019 10:25:42")
  ...
  comment = question.comments.create!(body: "Yes, this has proven to drastically reduce accidents in cities.",
                                      user_id: 4,
                                      created_at: "04/08/2019 11:25:42")
  up_voters = users.sample(2)
  up_voters.each do |voter|
    comment.vote_by(voter: voter, vote: true)
  end
  comment.update(updated_at: "04/08/2019 11:25:42")

  comment = question.comments.create!(body: "It would be enough 40 km/h",
                                      user_id: 6,
                                      created_at: "04/08/2019 12:25:42")
  up_voters = users.sample(1)
  up_voters.each do |voter|
    comment.vote_by(voter: voter, vote: true)
  end
  comment.update(updated_at: "04/08/2019 12:25:42")

  comment = question.comments.create!(body: "I think it's a too low speed. It would also have a big impact on our schedules.",
                                      user_id: 5,
                                      created_at: "04/08/2019 15:25:42")
  down_voters = users.sample(5)
  down_voters.each do |voter|
    comment.vote_by(voter: voter, vote: false)
  end
  comment.update(updated_at: "04/08/2019 15:25:42")

  comment = question.comments.create!(body: "Our safety should be over our working times.",
                                      ancestry: Comment.last.id,
                                      user_id: 7,
                                      created_at: "05/08/2019 12:25:42")
  up_voters = users.sample(2)
  up_voters.each do |voter|
    comment.vote_by(voter: voter, vote: true)
  end
  comment.update(updated_at: "05/08/2019 12:25:42")

  question.update(updated_at: "05/08/2019 12:25:42")

  process.update(updated_at: "03/08/2019")
  ...
  process = Legislation::Process.create!(title: "Ordinance regulating the holding and protection of animals.",
                                         ...
                                         end_date: "31/12/2020",
                                         draft_publication_date: "02/08/2019",
                                         allegations_start_date: "02/08/2019",
                                         allegations_end_date: "31/10/2020",
  ...
  comment.update(updated_at: "03/08/2019")

  annotation.comments.create!(body: "I agree. That should be included in article 4.",
                              user_id: 9,
                              created_at: "04/08/2019 16:41:16",
                              updated_at: "04/08/2019 16:41:16")
  ...
  process = Legislation::Process.create!(title: "Human Rights Plan for the City",
                                         ...
                                         end_date: "31/12/2020",
                                         published: true,
                                         proposals_phase_start_date: "01/08/2019",
                                         proposals_phase_end_date: "31/10/2020",
  ...
  proposal.update(updated_at: "02/08/2019")
  ...
  proposal.update(updated_at: "03/08/2019")
  ...
  proposal.update(updated_at: "04/08/2019")
  ...
  proposal.update(updated_at: "05/08/2019")
  ...
  proposal.update(updated_at: "06/08/2019")
  ...
  proposal.update(updated_at: "07/08/2019")
end
